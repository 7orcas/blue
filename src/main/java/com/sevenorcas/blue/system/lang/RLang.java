...
public class RLang extends BaseRest {
    ...
    public JsonRes pack(
		...
		return service.langPackageJson(callObj.getOrgNr(), null, callObj.getLang(), loadFlag);
    }
    ...
    public Response packExcel(
    		@QueryParam ("co") CallObject callObj,
    		@QueryParam ("load") String loadFlag) throws Exception {
		return service.langPackageExcel(callObj.getOrgNr(), null, callObj.getLang(), loadFlag);
    }
	...
	public JsonRes uploadLabels(
		...
		return service.updateLabels(callObj.getOrgNr(), (String)null, callObj.getLang(), (String)null, filename);		
    }
