...
INSERT INTO cntrl.org (id, code, descr, org_nr, created) VALUES (1, 'Org 1', 'Org 1 Description', 1, NOW());
INSERT INTO cntrl.org (id, code, org_nr, created, active) VALUES (2, 'Org 2', 2, NOW(), false);
INSERT INTO cntrl.org (id, code, org_nr, created, dvalue) VALUES (3, 'Org 3', 3, NOW(), true);

INSERT INTO cntrl.role (id, code, org_nr, created) VALUES (1, 'LangEdit', 0, NOW());
INSERT INTO cntrl.role (id, code, org_nr, created) VALUES (2, 'Fix', 0, NOW());
